...
function resumen(){
  ...
  (function renderCdCards(){
    ...
    const cdsList = DATA.cds || [
      ...
      { id: 'UC_GIRARDOTA', label: 'CD UC Girardota', color: '#7B1FA2' },
      { id: 'OL_GIRARDOTA', label: 'CD OL Girardota', color: '#9C27B0' },
      { id: 'UC_PEREIRA', label: 'CD UC Pereira', color: '#E64A19' },
      { id: 'OL_PEREIRA', label: 'CD OL Pereira', color: '#FF5722' },
      { id: 'MANIZALES', label: 'CD Manizales', color: '#00897B' },
...
function buildFilterBar(){
  ...
  const CDS_LIST = DATA.cds || [
    ...
    { id: 'UC_GIRARDOTA', label: 'CD UC Girardota' },
    { id: 'OL_GIRARDOTA', label: 'CD OL Girardota' },
    { id: 'UC_PEREIRA', label: 'CD UC Pereira' },
    { id: 'OL_PEREIRA', label: 'CD OL Pereira' },
    { id: 'MANIZALES', label: 'CD Manizales' },
